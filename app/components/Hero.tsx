...
export const Hero = (props: Header1Props) => {
  ...
  return (
    <section
      id="relume"
      className="bg-[#f4f4ec] px-[5%] py-16 md:py-24 lg:py-28 relative overflow-hidden"
    >
      <div className="container mx-auto">
        <div className="grid grid-cols-1 gap-x-20 gap-y-12 md:gap-y-16 lg:grid-cols-2 lg:items-center">
          <div className="relative">
            <h1 className="mb-5 text-4xl font-extrabold text-[#2a5934] md:mb-6 md:text-5xl lg:text-6xl xl:text-7xl">
            ...
            <p className="text-lg text-[#4b4b4b] md:text-xl">
              Experience the taste of fresh,{" "}
              <span className="font-bold text-[#28a745]">chemical-free</span> produce, sustainably
              grown with love at Fresh Roots Farm.
            </p>
            <div className="mt-6 flex justify-center md:mt-8 relative">
              <Button
                {...buttons[0]}
              ...
              {/* Bee Animation */}
              <img
                src="/bee.png" // Update to your bee image path
                className="absolute w-12 h-12 animate-bee" // Adjust size based on your preference
                alt="Bee sitting on button"
                style={{ top: "-40px", left: "50%", transform: "translate(-50%, 0)" }} // Positioned above button without gap
              />
            </div>
          </div>
          <div>
            <img
              src="/hero.png" // Update to your image path
...
export const Header1Defaults: Header1Props = {
  ...
  buttons: [{ title: "Discover Freshness", variant: "primary" }],
  image: { src: "/hero.png", alt: "Fresh vegetables" },
};
